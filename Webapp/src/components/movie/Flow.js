  ...
  return(
    <>
      ...
      <AnimatePresence mode='wait'>
        <motion.div 
          className={`movie-wrapper ${ (movies.length === 1 || mosaic) ? '' : 'default-grid'}`} 
        ...
        >
          { content }
          { mosaic && load && 
          <svg className='movie-wrapper-loader' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
